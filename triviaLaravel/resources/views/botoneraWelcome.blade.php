...
<div class="container __jumbotron my-5">
    <div class="row my-5">
        ...
        <div class="col-12 my-2 mx-auto botones" style="border-radius: 30px;">
            <a href="{{url('/jugar')}}"><button type="button" style="border-radius: 30px; border: 1px solid #000!important;" class="__btn btn btn-primary btn-md btn-block text-wrap">JUGAR</button></a>
        </div>
