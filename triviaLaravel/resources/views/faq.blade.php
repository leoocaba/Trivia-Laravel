...
<div class="container my-2">
  <div class="mx-2 row d-flex justify-content-center">
      <div class="col-12 col-lg-10 py-2 px-3" id="accordion" style="font-family:ZCOOL KuaiLe; border-radius:30px; background-color:#292b2c">
        <div class="card my-2" style="border-radius:30px; background-color:#FF4848">
        ...
        <div class="card my-2" style="border-radius:30px; background-color:#F4A460">
        ...
        <div class="card my-2" style="border-radius:30px; background-color:#FFFF84">
        ...
        <div class="card my-2" style="border-radius:30px; background-color:#F5DEB3">
        ...
        <div class="card my-2" style="border-radius:30px; background-color:#98FB98">
        ...
        <div class="card my-2" style="border-radius:30px; background-color:#1FFEF3">
